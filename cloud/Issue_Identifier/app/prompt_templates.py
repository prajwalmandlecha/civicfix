...
def build_prompt(
    ...
    prompt = (
        ...
        "2) **CRITICAL: Return MAXIMUM 3 MAIN issue types only.** Focus on:\n"
        "   - Primary/most severe issue visible in the image\n"
        "   - Safety-critical or health-risk issues\n"
        "   - Issues that require immediate attention\n"
        "   DO NOT include secondary, minor, or tangentially related issues.\n"
        ...
        "4) Detect and add ONLY the PRIMARY additional issue visible in the image (if any).\n"
